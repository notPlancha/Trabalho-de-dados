...
Gráfico 2
    Pela o primeiro gráfico verificamos que de um modo geral este questionário atingiu um público com idades muito variadas desde os 18 aos 87 anos visivel pela distribuição aglomerada dos pontos em todo o gráfico.


Gráfico 3
    Pela análise do segundo gráfico verificamos que a grande na maioria dos inquiridos, os seus respetivos agregados são compostos entre 5 a 10 elementos sendo aquele que possui o valor máximo o 5 que corresponde a aproximadamente 300 dis inquiridos.
    Em relação ao último gráfico concluimos que na resposta ao pPreocuparDemasiado verificou-se uma distribuição uniforme tendo em conta o agregado familiar dos inquiridos, ou seja, em todos os escalões do agregado familiar houve respostas diferentes, o que revela que não existe uma relação direta entre estas duas variaveis.
