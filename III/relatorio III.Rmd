...
##Gráfico 2
plot(data$idade, main = "Dístribuição da idade dos inquiridos", xlab = "Índices dos vários inquiridos", ylab = "Idades", col = "blue")

##Gráfico 3
hist(data$agregado, main = "Distribuição do agregado dos inquiridos", xlab = "Agregados", ylab = "Inquiridos", col = "red")

##Gráfico 4
ggplot(data, aes(x = pPreocuparDemasiado, y = agregado)) + geom_point()
(Preciso de ajuda para meter titulo e tirara a label no x)
