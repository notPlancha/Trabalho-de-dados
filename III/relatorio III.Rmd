...
Percentagem_Correspondente_urbrural <- 100*prop.table(Frequência_Absoluta_urbrural)
urbrural <- cbind(Frequência_Absoluta_urbrural, Percentagem_Correspondente_urbrural)
```
