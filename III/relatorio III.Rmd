...
colnames(data)
```
# 3 - Tratamento dos dados (Parte I)
...
# 4 - Tratamento (Parte II)
(Imputação dos valores omissos de uma variável, com a mediana dos seus outros valores)
```{r}
